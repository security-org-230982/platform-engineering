...
variable "cluster_name" { type = string default = "game-dev-eks" }
...
variable "domain_name" { type = string default = "dev.example.com" }
variable "route53_zone_name" { type = string default = "example.com" }
